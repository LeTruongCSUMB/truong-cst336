...
<html>
    ...
    <body>
        ...
        <form action="save.php" method="POST">
            ...
            <br>
            <input type="radio" id="8pass" name="8 character password" value="8pass">
                    <label for="8">8 characters</label>
            <br>
            <input type="radio" id="16pass" name="16 character password" value="16pass">
                    <label for="16">16 characters</label>
            <br>
            <input type="radio" id="32pass" name="32 character password" value="32pass">
